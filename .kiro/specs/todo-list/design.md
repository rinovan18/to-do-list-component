...
Tampilan visual komponen mengikuti **HAX Polaris theme aesthetic** (kompatibel dengan template `polaris-flex` dan `polaris-sidebar`): card-based layout dengan bayangan halus, palet warna biru/slate, tipografi besar dan bersih, serta spacing yang lapang — sehingga komponen terasa natural di dalam situs HAXcms berbasis tema Polaris. Semua nilai visual tetap menggunakan DDD CSS custom properties (termasuk token `--ddd-theme-polaris-*` dan token DDD standar yang relevan).
    ...
    return [
      ...
      css`
        ...
        :host {
          ...
          background: var(--ddd-theme-polaris-background, var(--ddd-theme-background));
        ...
        .task-input {
          ...
          border: 1.5px solid var(--ddd-theme-polaris-border, var(--ddd-theme-accent));
          border-radius: var(--ddd-radius-md);
          background: var(--ddd-theme-polaris-surface, var(--ddd-theme-background));
          color: var(--ddd-theme-polaris-text, var(--ddd-theme-primary));
          outline: none;
        ...
        .add-button {
          ...
          color: var(--ddd-theme-polaris-primary-text, var(--ddd-theme-background));
          border: none;
          border-radius: var(--ddd-radius-xl);
          cursor: pointer;
          white-space: nowrap;
          transition: background 0.15s ease, box-shadow 0.15s ease;
          box-shadow: 0 var(--ddd-spacing-1) var(--ddd-spacing-3) rgba(0, 0, 0, 0.12);
        }

        .add-button:hover {
          background: var(--ddd-theme-polaris-primary-hover, var(--ddd-theme-link));
          box-shadow: 0 var(--ddd-spacing-1) var(--ddd-spacing-4) rgba(0, 0, 0, 0.18);
        }
        ...
        .task-item {
          ...
          padding: var(--ddd-spacing-4) var(--ddd-spacing-5);
          margin-bottom: var(--ddd-spacing-3);
          background: var(--ddd-theme-polaris-surface, var(--ddd-theme-background-secondary));
          border-radius: var(--ddd-radius-lg);
          border-left: var(--ddd-spacing-1) solid var(--ddd-theme-polaris-accent, var(--ddd-theme-accent));
          box-shadow: 0 1px var(--ddd-spacing-3) rgba(0, 0, 0, 0.06);
          transition: box-shadow 0.15s ease;
        }

        .task-item:hover {
          box-shadow: 0 var(--ddd-spacing-1) var(--ddd-spacing-5) rgba(0, 0, 0, 0.1);
        }
        ...
        .task-checkbox {
          ...
          cursor: pointer;
          accent-color: var(--ddd-theme-polaris-primary, var(--ddd-theme-accent));
          flex-shrink: 0;
        }
        ...
        .delete-button:focus-visible {
          outline: none;
          box-shadow: 0 0 0 3px rgba(var(--ddd-theme-error-rgb, 220, 38, 38), 0.25);
        }
        ...
        .empty-message {
          ...
          background: var(--ddd-theme-polaris-surface, var(--ddd-theme-background-secondary));
          border-radius: var(--ddd-radius-lg);
          border: 1.5px dashed var(--ddd-theme-polaris-border, var(--ddd-theme-accent));
...
|------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Font       | `--ddd-font-primary`, `--ddd-font-size-xl`, `--ddd-font-size-m`, `--ddd-font-size-s`, `--ddd-font-size-xs`, `--ddd-font-weight-bold`                                                                                                         |
| Spacing    | `--ddd-spacing-1` hingga `--ddd-spacing-10`                                                                                                                                                                                                  |
| Warna      | `--ddd-theme-polaris-primary`, `--ddd-theme-polaris-primary-text`, `--ddd-theme-polaris-primary-hover`, `--ddd-theme-polaris-accent`, `--ddd-theme-polaris-background`, `--ddd-theme-polaris-surface`, `--ddd-theme-polaris-border`, `--ddd-theme-polaris-text`, `--ddd-theme-polaris-focus-ring`, `--ddd-theme-error`, `--ddd-theme-disabled` |
| Border     | `--ddd-radius-lg`, `--ddd-radius-md`, `--ddd-radius-xl`                                                                                                                                                                                      |
| Opacity    | `--ddd-opacity-50`                                                                                                                                                                                                                           |
| Fallback   | Setiap Polaris token menyertakan fallback ke token DDD standar (`var(--ddd-theme-primary)`, `var(--ddd-theme-accent)`, dll.) agar komponen tetap berfungsi di luar konteks tema Polaris.                                                       |

Tidak ada nilai hardcoded. Semua nilai visual berasal dari DDD tokens (Polaris layer di atas token DDD base).
